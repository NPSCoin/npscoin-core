...
NPSCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 9855.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 9856 for connections and services them.
...
However, in open source software such as NPSCoin Core, where everyone uses
...
pay attention to for reviewers of NPSCoin Core code.

General NPSCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: NPSCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
