...
This mechanism has been integrated into Bitcore-Node-NPSCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/NPSCoin/insight-api-npscoin#web-socket-api](https://github.com/NPSCoin/insight-api-npscoin#web-socket-api)
* API: [https://github.com/NPSCoin/insight-api-npscoin#instantsend-transactions](https://github.com/NPSCoin/insight-api-npscoin#instantsend-transactions)
...
By default, the NPSCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the NPSCoin Core daemon:
