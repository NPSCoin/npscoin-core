...
NPSCoin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ NPS, _12_ times over the course of a year totaling _24000_ NPS.

**Warning: if you change any fields within this command, the collateral transaction will become invalid.**

Format: ```mngovernance prepare proposal-name url payment-count block-start npscoin-address monthly-payment-npscoin```

Example: ```mngovernance prepare cool-project http://www.cool-project/one.json 12 100000 N6R9oN12KnB9zydzTLc3LikD9cCjjQzYG7 1200 true```
...
Format: ```mngovernance submit proposal-name url payment-count block-start npscoin-address monthly-payment-npscoin fee-tx```

Example: ```mngovernance submit cool-project http://www.cool-project/one.json 12 100000 N6R9oN12KnB9zydzTLc3LikD9cCjjQzYG7 1200 464a0eb70ea91c94295214df48c47baa72b3876cfb658744aaf863c7b5bf1ff0```
...
```
{
    ...
    "PaymentAddress" : "N6R9oN12KnB9zydzTLc3LikD9cCjjQzYG7",
    "Ratio" : 0.00000000,
    "Yeas" : 0,
    "Nays" : 0,
    "Abstains" : 0,
...
When block ```1000000``` is reached you'll receive a payment for ```1200``` NPS to ```N6R9oN12KnB9zydzTLc3LikD9cCjjQzYG7```.
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using npscoin.conf setup)
