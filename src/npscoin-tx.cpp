...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("NPSCoin Core npscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  npscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded npscoin transaction") + "\n" +
              "  npscoin-tx [options] -create [commands]   " + _("Create hex-encoded npscoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded npscoin transaction
