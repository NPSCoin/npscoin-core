 ...
 *
 *   // network
 *   CNPSCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.npscoin.io/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CNPSCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CNPSCoinNetwork(UniValue objIn)
    {
...
// // can be under: NPSCoinNetwork
// //   -- signature requirements : Key1(User)
// class CNPSCoinNetworkVariable : public CGovernanceObject
// {
// private:
