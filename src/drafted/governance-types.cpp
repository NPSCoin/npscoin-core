...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "NPSCoinNetwork") type = NPSCoinNetwork;
    if(strType == "NPSCoinNetworkVariable") type = NPSCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == NPSCoinNetwork) s = "NPSCoinNetwork";
    if(type == NPSCoinNetworkVariable) s = "NPSCoinNetworkVariable";
