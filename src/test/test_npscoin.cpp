...
#define BOOST_TEST_MODULE NPSCoin Test Suite

#include "test_npscoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_npscoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
