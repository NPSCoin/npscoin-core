    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("NPS-light"), QVariant("light"));
    ui->theme->addItem(QString("NPS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("NPS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("NPS-traditional"), QVariant("trad"));
