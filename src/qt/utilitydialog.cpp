    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("NPSCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About NPSCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  npscoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the NPSCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 NPS, 0.1 NPS, 1 NPS and 10 NPS -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://npscoin.io/PrivateSend\">https://npscoin.io/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("NPSCoin Core is shutting down...") + "<br /><br />" +
